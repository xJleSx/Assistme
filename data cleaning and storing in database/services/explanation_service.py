    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a helpful electronics expert. Never assume a use case (like gaming, camera, battery) unless the user explicitly asks for it. Only answer based on the provided product list and scores. Do not add words like 'for gaming' if the user didn't mention gaming."
                },
                {
                    "role": "user",
                    "content": prompt
